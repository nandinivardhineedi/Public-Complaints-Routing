...
// // // import { ComplaintCategory, ComplaintStatus, DataSource, Sentiment } from './types';
...
// // //   // *** CORRECTED STATE DECLARATION: Setter is now setActiveView ***
...
// // //         setIsLoggedIn(true);
// // //         setActiveView('dashboard'); // *** CORRECTED CALL: setActiveView ***
// // //         success = true;
// // //       } else {
...
// // //       setIsLoggedIn(true);
// // //       setActiveView('submit'); // *** CORRECTED CALL: setActiveView ***
// // //       success = true;
// // //     }

// // //     if (success) {
// // //         let updatedUser: User | null = currentUser;
        
// // //         if (role === 'admin') {
// // //             updatedUser = { ...currentUser!, id: MOCK_USERS.admin.id as string }; 
// // //         } else if (role === 'user') {
// // //             updatedUser = { ...currentUser!, id: 'USER_FIRESTORE_ID_TO_CREATE' }; // Placeholder
// // //         }
...
// // //                 source: c.source, username: c.username, location: c.location, complaint_text: c.complaint_text,
// // //                 timestamp: c.timestamp, status: c.status, assigned_authority: c.assigned_authority,
// // //                 sentiment: c.sentiment, category: c.category, external_id: c.external_id,
// // //             }));
...
// // //             id: response.firestoreId, // Internal Firestore ID is primary key 'id'
// // //             displayId: response.id, // Sequential ID for display
// // //             ...response
// // //         };
...
// // //       // Update local state with the new password so subsequent logins work
...
//   // FIX: Always start from a valid user, never ...currentUser!
//   const handleLogin = async (role: UserRole, username?: string, password?: string): Promise<boolean> => {
//     let success = false;
//     if (role === 'admin') {
//       const adminUser = MOCK_USERS.admin;
//       if (username === adminUser.username && password === adminUser.password) {
//         setCurrentUser({ ...adminUser }); // use fresh copy
//         setIsLoggedIn(true);
//         setActiveView('dashboard');
//         success = true;
//       } else {
...
//       }
//     } else if (role === 'user') {
//       // Use fresh copy, assign a placeholder ID
